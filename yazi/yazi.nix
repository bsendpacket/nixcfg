{ nixpkgs-unstable, nixpkgs-stable, config, colorscheme, workConfig, isNixOS, ... }: 
let
...
in {
  ...
  programs.yazi = {
    ...
    plugins = {
      # Hex viewer
      "hexyl" = nixpkgs-unstable.fetchFromGitHub {
        owner = "Reledia";
        repo = "hexyl.yazi";
        rev = "64daf93a67d75eff871befe52d9013687171ffad";
        hash = "sha256-B2L3/Q1g0NOO6XEMIMGBC/wItbNgBVpbaMMhiXOYcrI=";
      ...
      "glow" = nixpkgs-unstable.fetchFromGitHub {
        owner = "Reledia";
        repo = "glow.yazi";
      ...
      "ouch" = nixpkgs-unstable.fetchFromGitHub {
        owner = "ndtoan96";
        repo = "ouch.yazi";
      ...
      "fg" = nixpkgs-unstable.fetchFromGitHub {
        owner = "lpnh";
        repo = "fg.yazi";
      ...
      "relative-motions" = nixpkgs-unstable.fetchFromGitHub {
        owner = "dedukun";
      ...
      "mediainfo" = nixpkgs-unstable.fetchFromGitHub {
        owner = "Ape";
        repo = "mediainfo.yazi";
      ...
      # "projects" = nixpkgs-unstable.fetchFromGitHub {
      #   owner = "MasouShizuka";
      #   repo = "projects.yazi";
    ...
    settings = {
      ...
      opener = {
        edit = if isNixOS then [
          { run = "${nixpkgs-stable.contour}/bin/contour nvim \"$@\""; orphan = true; }
        ] else [
          { run = "nixGL ${nixpkgs-stable.contour}/bin/contour nvim \"$@\""; orphan = true; }
        ];
        ...
        json = [
          { run = "${nixpkgs-unstable.jless}/bin/jless $0"; desc = "View JSON with jless"; block = true; }
        ];
