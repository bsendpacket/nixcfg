...
let
  ...
  firefoxExtensions = with nixpkgs-unstable.nur.repos.rycee.firefox-addons; [
    ublock-origin
    privacy-badger
    clearurls
  ];
...
in 
{
  programs.firefox = {
    ...
    package = nixpkgs-unstable.wrapFirefox nixpkgs-unstable.firefox-unwrapped {
      extraPolicies = {
