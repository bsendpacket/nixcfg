{ nixpkgs-unstable, homeDirectory, ... }: {
  ...
  programs.nixvim = {
    ...
    extraPlugins = [
      ...
      {
        # Theme
        plugin = (nixpkgs-unstable.vimUtils.buildVimPlugin {
          name = "moonfly";
      ...
      nixpkgs-unstable.vimPlugins.vim-sleuth

      nixpkgs-unstable.vimPlugins.luasnip

      nixpkgs-unstable.vimPlugins.nui-nvim

      nixpkgs-unstable.vimPlugins.nvim-lspconfig
      nixpkgs-unstable.vimPlugins.fidget-nvim
    ];
